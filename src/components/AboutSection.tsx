                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="order-last md:order-first space-y-6" data-aos="fade-right">
                        <p className="text-lg text-gray-300 leading-relaxed">
                            I'm Mohammad Saquib, a Full Stack Developer with 4.5 years of experience building secure, scalable, and high-performing web applications. I specialize in React, Node.js, TypeScript, API development, payment gateway integrations, cloud services, and AI-driven conversational workflows.
                        </p>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div className="p-6 bg-gray-800/50 rounded-lg border border-gray-700" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <p className="text-gray-300">4.5 Years</p>
