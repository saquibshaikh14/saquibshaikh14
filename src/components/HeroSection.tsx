            ...
            <div className="container px-4 mx-auto">
                <div className="text-center space-y-8 max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-wrap gap-6 justify-center items-center" data-aos="fade-up" data-aos-delay="200">
                        <a href="#portofolio" className="min-w-40 px-8 py-3 bg-gradient-to-r from-primary to-secondary rounded-full text-white font-semibold hover:opacity-90 transition-all duration-300 transform hover:scale-105">
                            Portfolio
                        </a>
